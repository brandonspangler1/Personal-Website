...
<body>
    ...
    if (isset($_POST['create'])) {
        ...
        echo "<script>
                alert('The request has been submitted. Your request shall be reviewed by the Super Administrator and you shall be notified by email for any request status changes. Please check your emails spam folder too!'); 
