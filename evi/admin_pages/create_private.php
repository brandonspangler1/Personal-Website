...
<body>
    ...
    <?php 
        if(isset($_POST['create']))
        {
            ...
            $query = "INSERT INTO `private_events`(`university`, `name`, `date`, `time_from`, `time_to`, `category`, `description`, `location`, `email`, `phone`) VALUES ('$university', '$name', '$date', '$start_time', '$end_time', '$cat', '$des', '$location', '$email', '$phone')";
            mysqli_query($con, $query);
            echo "<script>
                    window.location.href='admin_private.php'; 
                  </script> ";
        }
    ?>
