                ...
                if ($result) {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($name = mysqli_fetch_assoc($result)) {
                            ...
                            $active_status_query = "SELECT * FROM `rso_active` WHERE `name`='$name[name]' AND `university`='$name[university]' AND `admin_name`='$name[admin_name]'";
                    ...
                    if ($join_result) {
                        ...
                        if ($member_result) {
                            ...
                            if ($num_members >= 5) {
                                ...
                                $update_active_status = "UPDATE `rso_active` SET `status`='1' WHERE `name`='$rso_info[name]' AND `university`='$university'";
                                $update_result = mysqli_query($con, $update_active_status);
