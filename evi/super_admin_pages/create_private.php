...
<head>
    ...
    <title>Create Private Event</title>
    <link rel="stylesheet" href="css/create_private.css" />
</head>
...
<body>
    ...
    <div class="create_private_event">
        <form style="text-align: center;" method="POST">
            ...
            <div class="create_button">
                <button type="submit" class="create-btn" name="create_private">CREATE</button>
            </div>
        </form>
    </div>
    ...
    if (isset($_POST['create_private'])) {

        $insert_query = "INSERT INTO `private_events`(`university`, `name`, `date`, `time_from`, `time_to`, `category`, `description`, `location`, `email`, `phone`) VALUES ('$uni_name','$_POST[name]','$_POST[date]','$_POST[time_from]','$_POST[time_to]','$_POST[category]','$_POST[description]','$_POST[location]','$_POST[email]','$_POST[phone]')";

        if (mysqli_query($con, $insert_query)) {

            echo "
                 <script>
                    alert('Private Event: $_POST[name] Has Been Created'); 
