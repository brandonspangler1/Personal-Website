...
<head>
    ...
    <link rel="stylesheet" href="css/student_public_info.css?1" />
</head>
            ...
            <div class="describe">
                ...
                <div class="social_network">
                    <div class="twitter_share">
                        <a class="twitter-share-button" href="https://twitter.com/intent/tweet" data-size="large" data-text="<?php echo $public_name; ?> on <?php echo $public_date; ?> at <?php echo $public_university; ?>." data-url="https://www.brandonspangler.com/evi" data-hashtags="EVI,EventPlanner">
                            Tweet
                        </a>
                    </div>
